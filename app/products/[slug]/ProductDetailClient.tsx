      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
            ...
            <div className="flex gap-2">
              {images.map((img, i) => (
                <button key={i} onClick={() => setActiveImage(i)}
                  className={`w-14 h-14 rounded-lg overflow-hidden border-2 transition ${i === activeImage ? 'border-green-500' : 'border-transparent'}`}>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className="text-2xl font-bold text-green-600 dark:text-green-400">{formatPrice(price)}</span>
