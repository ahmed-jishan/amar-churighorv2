          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4">
              {cart.length === 0 ? (
                ...
                cart.map(item => (
                  <div key={item.id} className="flex gap-3 border-b border-[#1f3334] pb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        ...
                        <button onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          className="w-6 h-6 flex items-center justify-center bg-gray-200 dark:bg-gray-700 rounded text-sm font-bold">+</button>
                        <button onClick={() => removeFromCart(item.id)} className="ml-auto text-red-400 hover:text-red-600 transition">
